    ...
    <>
      ...
      <div className="bg-gray-100 py-1 md:py-5 px-2 md:px-16">
        <div className="grid md:grid-cols-12">
          <div className="col-span-9 md:pr-3">
            <div className="border rounded-2xl p-2 bg-white shadow-lg">
              ...
              <div className=" relative h-12 bg-white">
                <div className="absolute w-24 h-24 rounded-full bg-white -top-12 left-10 p-1 overflow-hidden">
                  <img
                    className="rounded-full"
                    src="https://img.freepik.com/free-photo/androgynous-avatar-non-binary-queer-person_23-2151100226.jpg?t=st=1705571271~exp=1705574871~hmac=555ec1dd1d7b337862975d25c478f86750a7da510e63c4685f1c88ddc1d5d740&w=1060"
                    alt=""
                  />
                </div>
              </div>
              <div className="px-10 mt-2 grid grid-cols-2">
                ...
                <div className="justify-end items-center hidden md:flex">
                  <div className="flex flex-col rounded-xl bg-gray-100 py-2 px-4 gap-y-1 shadow">
                    <p className="text-gray-700 font-semibold">Follow Me</p>
            ...
            <div className="shadow-lg bg-white rounded-2xl mt-5 overflow-hidden px-5 py-5">
              <p className="font-bold text-xl text-gray-500">Track Your Order</p>
              <div className="flex justify-between items-center mt-5">
                <div className="flex items-center gap-x-3 mt-4">
                  <div className="w-20 h-20  rounded-md bg-red-900 overflow-hidden">
                    <img
                      src="https://images.unsplash.com/photo-1597589827317-4c6d6e0a90bd?q=80&w=2960&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                      alt=""
                    />
                  </div>
                  <div>
                    ...
                    <p className="font-md text-md text-gray-400">1 Piece</p>
                  </div>
                </div>
                <p className="font-bold text-xl text-gray-700">$ 500</p>
              </div>
              <div className="flex items-center gap-x-2 mt-10 mb-8 md:px-16">
                <div className="w-10 h-10 rounded-full flex justify-center">
                  <img src="https://www.svgrepo.com/show/3285/clipboard.svg" alt="" />
                </div>
                <div className="flex-auto bg-gray-200 h-1 rounded-full overflow-hidden">
                  <div className="w-[100%] bg-green-600 h-full" />
                </div>
                <div className=" w-10 h-10 flex items-center justify-center rounded-full">
                  <img src="https://www.svgrepo.com/show/9807/shipping.svg" alt="" />

                </div>
                <div className="flex-auto bg-gray-200 h-1 rounded-full overflow-hidden">
                  <div className="w-[60%] bg-green-600 h-full" />
                </div>
                <div className="w-10 h-10 rounded-full flex justify-center">
                  <img src="https://www.svgrepo.com/show/58865/package.svg" alt="" />
                </div>
              </div>
              <div className="flex justify-center mt-10">
                <button className="shadow-lg flex hover:bg-red-700 gap-x-1  items-center py-2 px-4 bg-red-600 rounded-md text-white">
                  <svg
                    fill="#ffffff"
                    version="1.1"
                    id="Capa_1"
                  ...
                  <span className="text-sm">Order Cancel</span>
                </button>
              </div>
            </div>
            <div className="shadow-lg bg-white rounded-2xl mt-5 overflow-hidden px-5 py-5">
              <p className="font-bold text-xl text-red-500">Delete Account </p>
              <div>
                <div className="flex gap-x-2 mt-4">
                  ...
                  <span className="text-gray-700 font-medium">
                    If you Delete the Account it will Permanantly remove from our
                    database and orders will be cancelled.
                  </span>
                </div>
          ...
          <div className="hidden md:block md:col-span-3 pl-3">
            <div className="bg-white rounded-lg shadow-lg p-4">
              ...
              <ul className="mt-6 space-y-2">
                <li className="flex rounded-md overflow-hidden shadow-md">
                  ...
                  <div className="flex flex-col justify-center flex-1 bg-gray-100 pl-2">
                    <p className="font-semibold text-gray-500">Men's Black Top 350</p>
                    <p className="font-semibold text-gray-600">$ 530.00</p>
                  </div>
                </li>
                <li className="flex rounded-md overflow-hidden shadow-md">
                  <div className="w-16 h-16 bg-gray-500">
              ...
              <p className="text-blue-400 underline font-semibold text-center cursor-pointer mt-1">
                show more
              </p>
            </div>
            <div className="bg-white rounded-lg shadow-lg p-4 mt-4">
              <div className='flex gap-x-1 items-center'>
                ...
                <div>
                  <p className="text-gray-700 font-semibold text-2xl">Favourites</p>
                </div>
              </div>
              <ul className="mt-6 space-y-2">
                <li className="flex rounded-md overflow-hidden shadow-md">
